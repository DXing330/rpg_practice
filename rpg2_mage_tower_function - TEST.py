...
hero_bag = ItemBag_PC(1, 1, 1, 100)
heroes_magic = []
heroes_party = []
summoner = Player_PC("Summoner", 1, 1, 1, 1, 1, 1, 1)
party_func.add_to_party(heroes_party, summoner)
...
while bPet:
        ...
        bPet = False
hero_pet.stats()
mage_tower(heroes_party, hero_pet, hero_bag, heroes_magic)
hero_pet.stats()
mage_tower(heroes_party, hero_pet, hero_bag, heroes_magic)

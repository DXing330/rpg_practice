...
warrior = Player_PC("Warrior", 10, 15000, 15000, 60, 3000, 0, 0, 0, 0, 2, 1)
...
knight = Player_PC("Knight", 1, 2000, 2000, 4, 4, 0, 0, 0, 0, 0, 20)
heroes_pet = Pet_NPC("Angel", 6, 2)
...
boss_battle_phase(heroes_party, boss_party, heroes_pet, heroes_bag, heroes_magic)

        ...
        if a_pc == None:
                ...
                if a_pc.effect == "Block":
                        ...
                        print(a_pc.user, "blocks some of energy from the attack of ",
                              m_npc.name)
                elif a_pc.effect == "Bomb" and a_pc.upgrade == 0:
                        for mon in m_p:
                                mon.health -= a_pc.strength
                        p_pc.health -= a_pc.strength
                elif a_pc.effect == "Bomb":
                        for mon in m_p:
...
def weapon_effect(m_npc, p_pc, w_pc, h_p, m_p):
        if w_pc == None:
                ...
                elif w_pc.effect == "Death" and w_pc.element == "Dark" and w_pc.upgrade == 0:
                ...
                elif w_pc.effect == "Hidden Dagger" and w_pc.user == "Ninja" and w_pc.upgrade == 0:
                        if w_pc.atk == 0 and w_pc.strength > 0:
                                w_pc.atk += w_pc.strength
                                w_pc.strength = 0
                elif w_pc.effect == "Hidden Dagger" and w_pc.user == "Ninja":
                        if w_pc.atk == 0 and w_pc.strength > 0:
                ...
                elif w_pc.effect == "Necromancer" and w_pc.upgrade == 0:

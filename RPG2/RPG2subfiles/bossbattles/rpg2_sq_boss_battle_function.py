...
def illusion_maker():
        monster = ("Beauty", 1, 1, 1, 0, "Dark", 0)
        return monster
def sq_illusion_maker():
        monster = ("Sucubus Queen", 1, 1, 1, 0, "Dark", 0)
        return monster
#illusion action
...
#phase one actions
def sq_phase_one_action(m_npc, h_p, b_p):
        ...
        for hero in h_p:
                if hero.name != "Golem":
                        mon = illusion_maker()
                        b_p.append(mon)
                        print (m_npc.name, "steps out from behind a curtain and smiles at", hero.name)
...
def sq_phase_one(h_p, b_p, p_npc, ib_pc, s_pc):
        ...
        while bPhase1:
                for mon in b_p:
                        if mon.name == "Succubus Quuen" and mon.health == B.S_Q_HEALTH * (C.BUFF ** ib_pc.sq_trophy):
                ...
                if len(h_p) == 0:
                        ...
                        for mon in b_p:
                                ...
                                elif mon.health > 0 and mon.name == "Succusbus Queen":
                                        monster_action(mon, h_p)
                                        sq_phase_one_action(mon, h_p, b_p)
        ...
        while bBattle:
                ...
                for mon in new_b_p:
                        if mon.name == "Succubus Queen" and mon.health <= 0:
                                ...
                                print("from the monsters, their wives are another story. ")
                                bBattle = False
                ...
                if len(new_h_p) == 0:
                        ...
                        for mon in new_b_p:
                                ...
                                elif mon.name == "Succubus Queen" and mon.health < (B.S_Q_HEALTH * (C.BUFF ** ib_pc.sq_trophy)) * B.S_Q_HPBP:

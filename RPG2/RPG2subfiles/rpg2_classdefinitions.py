...
##classes
#list of debuffs that can be inflicted
class Statuses_NPC:
...
class Weapon_PC:
        def __init__(self, name, effect, strength, element, atk):
                #the owner and user of the weapon
                self.name = name
...
class Armor_PC:
        def __init__(self, name, effect, strength, element, defense):
                #the owner and user of the armor
                self.name = name
